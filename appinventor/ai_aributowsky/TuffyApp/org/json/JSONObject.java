...
public class JSONObject {
    ...
    public static String doubleToString(double d) {
        ...
        if (string.indexOf(46) <= 0 || string.indexOf(ErrorMessages.ERROR_LOCATION_SENSOR_LATITUDE_NOT_FOUND) >= 0 || string.indexOf(69) >= 0) {
            return string;
        }
                ...
                if (Modifier.isPublic(method.getModifiers())) {
                    ...
                    if (name.startsWith("get")) {
                        if ("getClass".equals(name) || "getDeclaringClass".equals(name)) {
                            key = ElementType.MATCH_ANY_LOCALNAME;
                        } else {
    ...
    public static Object stringToValue(String string) {
        if (string.equals(ElementType.MATCH_ANY_LOCALNAME)) {
            return string;
        }
        ...
        try {
            if (string.indexOf(46) > -1 || string.indexOf(ErrorMessages.ERROR_LOCATION_SENSOR_LATITUDE_NOT_FOUND) > -1 || string.indexOf(69) > -1) {
    ...
    public static Object wrap(Object object) {
        if (object == null) {
            ...
            String objectPackageName = objectPackage != null ? objectPackage.getName() : ElementType.MATCH_ANY_LOCALNAME;
    ...
    Writer write(Writer writer, int indentFactor, int indent) throws JSONException {
        ...
        try {
            int length = length();
            Iterator keys = keys();
            writer.write(srfi1.$Pcprovide$Pcsrfi$Mn1);
            Object key;
            if (length == 1) {
                key = keys.next();
