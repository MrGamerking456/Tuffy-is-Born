...
public class ACRA {
    ...
    static class C03101 implements OnSharedPreferenceChangeListener {
        C03101() {
        }
    ...
    static void checkCrashResources() throws ACRAConfigurationException {
        ...
        switch (C03112.$SwitchMap$org$acra$ReportingInteractionMode[conf.mode().ordinal()]) {
