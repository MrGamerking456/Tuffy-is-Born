...
public final class CrashReportDialog extends Activity {
    ...
    class C03121 implements OnClickListener {
        ...
        public void onClick(View v) {
            String usrEmail;
            String comment = CrashReportDialog.this.userComment != null ? CrashReportDialog.this.userComment.getText().toString() : ElementType.MATCH_ANY_LOCALNAME;
            if (CrashReportDialog.this.prefs == null || CrashReportDialog.this.userEmail == null) {
                usrEmail = ElementType.MATCH_ANY_LOCALNAME;
            } else {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (emailPromptId != 0) {
            ...
            if (savedValue != null) {
                ...
                this.userEmail.setText(this.prefs.getString(ACRA.PREF_USER_EMAIL_ADDRESS, ElementType.MATCH_ANY_LOCALNAME));
            }
        ...
        yes.setOnClickListener(new C03121());
        buttons.addView(yes, new LinearLayout.LayoutParams(-1, -2, 1.0f));
        Button no = new Button(this);
        no.setText(17039369);
        no.setOnClickListener(new C03132());
